...
public class PersonExcelWriter {
    ...
    private Workbook prepareWorkbook(List<Person> personList) {
        ...
        XSSFSheet personSheet2 = (XSSFSheet) workbook.createSheet("Persons2");
        XSSFSheet personSheet3 = (XSSFSheet) workbook.createSheet("Persons3");

        //set Persons2 sheet as active
